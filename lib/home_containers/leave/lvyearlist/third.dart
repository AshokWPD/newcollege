...
class thirdlvlist extends StatefulWidget {
  @override
  State<thirdlvlist> createState() => _thirdlvlistState();
}

class _thirdlvlistState extends State<thirdlvlist> {
          ...
          builder: (context, snapshot) {
            ...
            List<leavemodel> filteredPdfs = pdfs
                .where((pdf) =>
                    ...
                    pdf.year.toString() == "Data science")
                .toList();
