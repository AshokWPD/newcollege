...
class firstlvlist extends StatefulWidget {
  @override
  State<firstlvlist> createState() => _firstlvlistState();
}

class _firstlvlistState extends State<firstlvlist> {
          ...
          builder: (context, snapshot) {
            ...
            List<leavemodel> filteredPdfs = pdfs
                .where((pdf) =>
                    ...
                    pdf.year.toString() == "MSc Computer Science 1-Year")
                .toList();
