...
class Uploadnot extends StatefulWidget {
  const Uploadnot({Key? key}) : super(key: key);

  @override
  _UploadnotState createState() => _UploadnotState();
}

class _UploadnotState extends State<Uploadnot> {
  ...
  Future<String> _getPDFUrl(String id) async {
    DocumentSnapshot documentSnapshot =
        await FirebaseFirestore.instance.collection('notice').doc(id).get();
  ...
  Future<void> _uploadFile() async {
    ...
    try {
      ...
      String fileName = 'notice/$depp/$_fileName';
