...
class uploadaddstu extends StatefulWidget {
  const uploadaddstu({Key? key}) : super(key: key);

  @override
  _uploadaddstuState createState() => _uploadaddstuState();
}

class _uploadaddstuState extends State<uploadaddstu> {
  ...
  Future<String> _getPDFUrl(String id) async {
    DocumentSnapshot documentSnapshot =
        await FirebaseFirestore.instance.collection('usercsv').doc(id).get();
  ...
  Future<void> _uploadFile() async {
    ...
    try {
      ...
      String fileName = 'usercsv/$depp/$_fileName';
